...
class LegalZoomCredentialController extends Controller
{
    ...
    public function index(){
        ...
        $credential=ZoomCredential::where('lawyer_id',$legals->id)->first();
        $website_lang=ManageText::all();
        return view('legaloffice.zoom.setting.index',compact('credential','website_lang'));
    }
    ...
    public function store(Request $request){
        ...
        $credential->lawyer_id=$legals->id;
