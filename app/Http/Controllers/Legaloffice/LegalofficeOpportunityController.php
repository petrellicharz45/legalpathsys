...
class LegalofficeOpportunityController extends Controller
{
    ...
    {
        $user=Auth::guard('legal')->user();
        $opportunity=Opportunity::with('type')->where('user_id',$user->id)->get();
        $website_lang=ManageText::all();
        return view('legaloffice.opportunity.index',compact('opportunity','website_lang'));
    }
    ...
    public function create()
    {
        ...
        $website_lang=ManageText::all();
        return view('legaloffice.opportunity.create',compact('opportunitytypes','website_lang'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('legaloffice.opportunity.index')->with($notification);
    }
    ...
    public function edit(Opportunity $opportunity)
    {
        ...
        $opportunitytypes=Opportunitytype::orderBy('type','asc')->get();
        $website_lang=ManageText::all();
        return view('legaloffice.opportunity.edit',compact('opportunity','opportunitytypes','website_lang'));
    }
