...
class MeetingController extends Controller
{
    ...
    public function meetingHistory(){
        ...
        return view('student.profile.meeting-history',compact('histories','navigation','banner','user','website_lang'));
    }
    ...
    public function upCommingMeeting(){
        ...
        $navigation=Navigation::first();
        $website_lang=ManageText::all();
        return view('student.profile.upcoming-meeting',compact('histories','navigation','banner','user','website_lang'));
    }
}
