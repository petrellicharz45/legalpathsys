...
class MessageController extends Controller
{
    public function index(){
        ...
        return view('student.profile.message.index',compact('user','lawyers','banner','navigation','website_lang'));
    }
    ...
    public function messageBox($slug){
        ...
        return view('student.profile.message.single-message',compact('messages','doctors','banner','navigation','text','user','lawyer_id'));
    }
    ...
    public function getMessage($lawyer_id){
        ...
        Message::where(['user_id'=>$user->id,'lawyer_id'=>$lawyer_id])->update(['user_view'=>1]);
        $messages = Message::where(['user_id'=>$user->id,'lawyer_id'=>$lawyer_id])->get();
        return view('student.profile.message.message-box',compact('messages'));
    }
