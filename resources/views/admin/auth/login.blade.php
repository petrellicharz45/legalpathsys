                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">{{ $website_lang->where('lang_key','admin_login')->first()->custom_lang }}</h1>
                                </div>
                                ...
                                <div class="text-center">
                                    <a class="small" href="{{ route('admin.forget.password') }}">{{ $website_lang->where('lang_key','forget_pass')->first()->custom_lang }}</a>
                                </div>
                            </div>
                        </div>
                        @endif
