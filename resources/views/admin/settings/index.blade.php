...
@section('title')
<title>{{ $website_lang->where('lang_key','general_setting')->first()->custom_lang }}</title>
@endsection
        ...
        <div class="col-md-8">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">{{ $website_lang->where('lang_key','general_setting')->first()->custom_lang }}</h6>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.settings.update',$setting->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="">{{ $website_lang->where('lang_key','exist_logo')->first()->custom_lang }}</label>
                            @if ($setting->logo)
                        ...
                        <div class="form-group">
                            <label for="">{{ $website_lang->where('lang_key','logo')->first()->custom_lang }}</label>
                            <div><input type="file" name="logo" class="form-control"></div>
                        </div>

                        <div class="form-group">
                            <label for="">{{ $website_lang->where('lang_key','exist_favicon')->first()->custom_lang }}</label>
                            <br>
                            @if ($setting->favicon)
                        ...
                        <div class="form-group">
                            <label for="">{{ $website_lang->where('lang_key','favicon')->first()->custom_lang }}</label>
                            <div><input type="file" name="favicon" class="form-control"></div>
                        </div>

                        <div class="form-group">
                            <label for="">{{ $website_lang->where('lang_key','sidebar_header')->first()->custom_lang }}</label>
                            <input type="text" name="sidebar_header_name" class="form-control" value="{{ $setting->sidebar_header_name }}">
                        </div>

                        <div class="form-group">
                            <label for="">{{ $website_lang->where('lang_key','sidebar_icon')->first()->custom_lang }}</label>
                            <input type="text" name="sidebar_header_icon" class="form-control custom-icon-picker" value="{{ $setting->sidebar_header_icon }}">
                        </div>



                        <div class="form-group">
                            <label for="">{{ $website_lang->where('lang_key','email_contact_msg')->first()->custom_lang }}</label>
                            <input type="email" name="email" class="form-control" value="{{ $setting->email }}">
                        </div>


                        <div class="form-group">
                            <label for="">{{ $website_lang->where('lang_key','save_msg')->first()->custom_lang }} </label>
                            <select name="save_contact_message" id="" class="form-control">
                                <option {{ $setting->save_contact_message==0 ? 'selected':'' }} value="0">{{ $website_lang->where('lang_key','no')->first()->custom_lang }}</option>
                                <option {{ $setting->save_contact_message==1 ? 'selected':'' }} value="1">{{ $website_lang->where('lang_key','yes')->first()->custom_lang }}</option>
                            </select>
                        </div>

                        <div class="form-group">
                            <label for="">{{ $website_lang->where('lang_key','allow_reg')->first()->custom_lang }}</label>
                            <select name="patient_can_register" id="" class="form-control">
                                <option {{ $setting->patient_can_register==1 ? 'selected':'' }} value="1">{{ $website_lang->where('lang_key','yes')->first()->custom_lang }}</option>
                                <option {{ $setting->patient_can_register==0 ? 'selected':'' }} value="0">{{ $website_lang->where('lang_key','no')->first()->custom_lang }}</option>
                            </select>
                        </div>

                        <div class="form-group">
                            <label for="">{{ $website_lang->where('lang_key','text_dir')->first()->custom_lang }}</label>
                            <select name="text_direction" id="" class="form-control">
                                <option {{ $setting->text_direction=='LTR' ? 'selected':'' }} value="LTR">{{ $website_lang->where('lang_key','ltr')->first()->custom_lang }}</option>
                                <option {{ $setting->text_direction=='RTL' ? 'selected':'' }} value="RTL">{{ $website_lang->where('lang_key','rtl')->first()->custom_lang }}</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="currency_name" id="" class="form-control select2">
                                <option value="">{{ $website_lang->where('lang_key','select_currency')->first()->custom_text }}
                              </option>
                        ...
                        <div class="form-group">
                            <label for="">{{ $website_lang->where('lang_key','currency_icon')->first()->custom_lang }}</label>
                            <input type="text" class="form-control" name="currency_icon" value="{{ $setting->currency_icon }}">
                        </div>
                        <div class="form-group">
                            <label for="">{{ $website_lang->where('lang_key','currency_rate')->first()->custom_lang }}</label>
                            <input type="text" class="form-control" name="currency_rate" value="{{ $setting->currency_rate }}">
                        </div>

                        <div class="form-group">
                            <label for="">{{ $website_lang->where('lang_key','pre_notify')->first()->custom_lang }}</label>
                            <input type="number" class="form-control" name="prenotification_hour" value="{{ $setting->prenotification_hour }}">
                        </div>

        <div class="form-group">
            <label for="">{{ $website_lang->where('lang_key','timezone')->first()->custom_lang }}</label>
