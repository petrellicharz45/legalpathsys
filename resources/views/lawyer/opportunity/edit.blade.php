        ...
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('lawyer.opportunity.update',$opportunity->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="link" value="{{$opportunity->apply_link}}" id="link">
                                </div>
                            </div>
                            <div class="col-md-6">
                            <div class="form-group">
