                ...
                <div class="col-xl-9 col-lg-9 col-12">
                    <div class="header-info">
                        <ul>
                            ...
                            @if ($navbar->show_opportunity)
                            <li><a href="{{ url('opportunity') }}">{{ $navigation->opportunity }}</a></li>
                            @endif
                        ...
                        <ul class="nav-menu">
                            ...
                            <li class="menu-item-has-children"><a href="javascript:void;">{{ $navigation->pages }}</a>
                                <ul class="sub-menu">
                                    ...
                                    @if ($navbar->show_legaloffice)
                                <li><a href="{{ url('legaloffices') }}">{{ $navigation->legaloffice }}</a></li>
                            @endif
                                    ...
                                    @if ($navbar->show_library)
                                <li><a href="{{ url('library') }}">{{ $navigation->library }}</a></li>
                            @endif

                            @if ($navbar->show_probono)
                            ...
                            @if ($navbar->show_story)
                                <li><a href="{{ url('case') }}">{{ $navigation->story }}</a></li>
                            @endif
