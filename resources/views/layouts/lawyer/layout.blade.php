    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="opportunities" class="collapse {{Route::is('lawyer.application.*')||Route::is('lawyer.opportunity.*') ? 'show':'' }}" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item {{ Route::is('lawyer.opportunity.*') ?'active':'' }}" href="{{ route('lawyer.opportunity.index') }}">Oppportunities</a>
                        <a class="collapse-item {{ Route::is('lawyer.application.*') ?'active':'' }}" href="{{ route('lawyer.application.index') }}">Applications</a>
