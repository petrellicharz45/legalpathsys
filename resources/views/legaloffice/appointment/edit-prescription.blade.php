...
<div class="card shadow mb-4">
    <div class="card-body" id="search-particular-appointment">
        <div class="prescription">
            ...
            <div class="mt-3">
                <form action="{{ route('legaloffice.prescription-update',$appointment->id) }}" enctype="multipart/form-data" method="POST">
                    @csrf
                                ...
                                <div class="lawyer-doc-file">
                                    ...
                                    <ol>
                                        @foreach ($appointment->prescription->prescriptionFile as $item)
                                            <li class="doc-file-col-{{ $item->id }}"><a href="{{ route('legaloffice.download-doc',$item->file) }}">{{ $item->file }}</a> <span class="custom-doc-icon" onclick="deleteDoc('{{ $item->id }}')"><i class="fas fa-trash "></i></span></li>
                                        @endforeach
