                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Legal Office Login</h1>
                                </div>
                                <form class="user" action="{{ route('legaloffice.login') }}" method="POST">
                                    @csrf
                                ...
                                <div class="text-center">
                                    <a class="small" href="{{ route('legaloffice.forget.password') }}">{{ $website_lang->where('lang_key','forget_pass')->first()->custom_lang }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
