...
@section('lawyer-content')
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800"><a href="{{ route('legaloffice.opportunity.index') }}" class="btn btn-primary"><i class="fas fa-list" aria-hidden="true"></i>All Opportunities</a></h1>
    <!-- DataTales Example -->
    <div class="row">
        <div class="col-md-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('legaloffice.opportunity.update',$opportunity->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control" id="title"  value="{{$opportunity->title }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="email">Company Name *</label>
                                    <input type="text" name="company" class="form-control" id="company"  value="{{$opportunity->company }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="phone">Position *</label>
                                    <input type="text" name="position" class="form-control" id="position"  value="{{$opportunity->position }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="password">Salary Range *</label>
                                    <input type="text" name="salary" class="form-control" id="salary" value="{{$opportunity->salary }}">
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" id="description" class="summernote">{{ $opportunity->description }}</textarea>
                                </div>
                            </div>
                        </div>
