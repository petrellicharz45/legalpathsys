...
use App\Http\Controllers\Admin\ProbonoCaseController;
use App\Http\Controllers\Admin\OpportunityController;
use App\Http\Controllers\Admin\Auth\AdminForgotPasswordController;
use App\Http\Controllers\Admin\AdminProfileController;
use App\Http\Controllers\Admin\DashboardController;
use App\Http\Controllers\Admin\LocationController;
use App\Http\Controllers\Admin\DesginationController;
use App\Http\Controllers\Admin\OpportunitytypeController;
...
use App\Http\Controllers\Admin\LegalofficeController;
use App\Http\Controllers\Admin\CaseCategoryController;
use App\Http\Controllers\Admin\CaseController;
use App\Http\Controllers\Admin\CaseCommentController;
...
use App\Http\Controllers\Lawyer\LawyerOpportunityController;

use App\Http\Controllers\Legaloffice\LegalLeaveController;
use App\Http\Controllers\Legaloffice\LegalZoomCredentialController;
use App\Http\Controllers\Legaloffice\Auth\LegalofficeLoginController;
use App\Http\Controllers\Legaloffice\Auth\LegalofficeForgotPasswordController;
use App\Http\Controllers\Legaloffice\LegalofficeProfileController;
use App\Http\Controllers\Legaloffice\LegalofficeDashboardController;
use App\Http\Controllers\Legaloffice\LegalofficeAppointmentController;
use App\Http\Controllers\Legaloffice\LegalofficeMessageController;
use App\Http\Controllers\Legaloffice\LegalofficeMeetingController;
use App\Http\Controllers\Legaloffice\LegalofficeOpportunityController;
use App\Http\Controllers\Legaloffice\LegalofficeApplicationController;
use App\Http\Controllers\Legaloffice\LegalofficeScheduleController;
...
Route::get('/opportunity-details/{id}',[HomeController::class,'opportunityDetails']);
Route::post('comment-store',[HomeController::class,'commentStore']);
Route::post('story-store',[HomeController::class,'caseStore']);
...
Route::get('/legaloffices',[HomeController::class,'legaloffice']);
Route::get('/legaloffice-details/{slug}',[HomeController::class,'legalofficeDetails']);
Route::get('/search-legaloffice',[HomeController::class,'searchLegaloffice']);
Route::get('/search-library',[HomeController::class,'searchLibrary']);
Route::get('/case',[HomeController::class,'story']);
Route::get('/case-details/{title}',[HomeController::class,'storyDetails']);
Route::get('/probono',[HomeController::class,'probono']);
Route::get('/probono-details/{title}',[HomeController::class,'probonoDetails']);
Route::get('/library',[HomeController::class,'library']);

Route::get('/library-details/{book_title}',[HomeController::class,'libraryDetails']);
Route::post('/dowload/{pdf}',[HomeController::class,'download']);
    Route::get('/view/{pdf}',[ViewController::class,'view']);
    Route::get('/application/{title}',[ApplicationController::class,'application']);
...
Route::group(['as'=> 'client.', 'prefix' => 'client'],function (){
    ...
    Route::get('case',[ProfileController::class,'storyCreate'])->name('story');
    Route::post('case',[ProfileController::class,'storyStore'])->name('story.store');
...
Route::group(['as'=> 'admin.', 'prefix' => 'admin'],function (){
 ...
 // manage desgination and status
 Route::resource('desgination', DesginationController::class);
 Route::get('desgination-status/{id}',[DesginationController::class,'changeStatus'])->name('desgination.status');

 Route::resource('opportunitytype', OpportunitytypeController::class);
 Route::get('opportunitytype-status/{id}',[OpportunitytypeController::class,'changeStatus'])->name('opportunitytype.status');

 Route::resource('office', OfficeController::class);
 Route::get('office-status/{id}',[OfficeController::class,'changeStatus'])->name('office.status');
    ...
    // manage case category
    Route::resource('case-category', CaseCategoryController::class);
    Route::get('case-category-status/{id}',[CaseCategoryController::class,'changeStatus'])->name('case.category.status');
    ...
    Route::get('blog-comment-status/{id}',[BlogCommentController::class,'changeStatus'])->name('blog.comment.status');
     ...
     // Case comment
    Route::get('case-comment',[CaseCommentController::class,'allComments'])->name('case-comment');
    Route::get('delete-case-comment/{id}',[CaseCommentController::class,'deleteComment'])->name('delete.case.comment');
    Route::get('case-comment-status/{id}',[CaseCommentController::class,'changeStatus'])->name('case.comment.status');

      // manage blog,images,status
    Route::resource('case', CaseController::class);
    Route::get('case-status/{id}',[CaseController::class,'changeStatus'])->name('case.status');


    Route::resource('opportunity', OpportunityController::class);
    Route::get('opportunity-status/{id}',[OpportunityController::class,'changeStatus'])->name('opportunity.status');

    Route::resource('probono', ProbonoCaseController::class);
    Route::get('probono-status/{id}',[ProbonoCaseController::class,'changeStatus'])->name('probono.status');
    ...
    Route::resource('legaloffice', LegalofficeController::class)->shallow();
    Route::get('legaloffice-status/{id}',[LegalofficerController::class,'changeStatus'])->name('legals.status');
 ...
 // manage library
    ...
    Route::post('paymongo-update/{id}',[PaymentAccountController::class,'updateIPaymongo'])->name('paymongo-update');
 ...
 Route::get('library-page',[ManagePageController::class,'library'])->name('library.page');
  Route::post('library-page-update',[ManagePageController::class,'libraryUpdate'])->name('library.page.update');
...
Route::resource('opportunity',LawyerOpportunityController::class);
Route::resource('application',LawyerApplicationController::class);
Route::get('opportunity-status/{id}', [LawyerOpportunityController::class,'changeStatus'])->name('opportunity.status');
...
Route::group(['as'=> 'legaloffice.', 'prefix' => 'legaloffice'],function (){
    // login route
    Route::get('login',[LegalofficeLoginController::class,'legalLoginForm']);
    Route::post('login',[LegalofficeLoginController::class,'storeLoginInfo'])->name('login');
    Route::get('/logout',[LegalofficeLoginController::class,'legalLogout'])->name('logout');
    Route::get('forget-password',[LegalofficeForgotPasswordController::class,'forgetPassword'])->name('forget.password');
    Route::post('send-forget-password',[LegalofficeForgotPasswordController::class,'sendForgetEmail'])->name('send.forget.password');
    Route::get('reset-password/{token}',[LegalofficeForgotPasswordController::class,'resetPassword'])->name('reset.password');
    Route::post('store-reset-password/{token}',[LegalofficeForgotPasswordController::class,'storeResetData'])->name('store.reset.password');
    Route::resource('application',LegalofficeApplicationController::class);
    Route::resource('opportunity',LegalofficeOpportunityController::class);
    Route::get('opportunity-status/{id}', [LegalofficeOpportunityController::class,'changeStatus'])->name('opportunity.status');
    // manage lawyer profile
    Route::get('profile',[LegalofficeProfileController::class,'profile'])->name('profile');
    Route::post('update-profile',[LegalofficeProfileController::class,'updateProfile'])->name('update.profile');
    Route::post('change-password',[LegalofficeProfileController::class,'changePassword'])->name('change.password');
    Route::post('update-prescription',[LegalofficeProfileController::class,'prescriptionContactUpdate'])->name('update.prescription');

    // dashbaord
    Route::get('/',[LegalofficeDashboardController::class,'index'])->name('dashboard');
    Route::get('dashboard',[LegalofficeDashboardController::class,'index'])->name('dashboard');
    Route::resource('leave', LegalLeaveController::class);

    Route::get('today-appointment',[LegalofficeAppointmentController::class,'todayAppointment'])->name('today.appointment');
    Route::get('new-appointment',[LegalofficeAppointmentController::class,'newAppointment'])->name('new.appointment');
    Route::get('all-appointment',[LegalofficeAppointmentController::class,'allAppointment'])->name('all.appointment');
    Route::get('meet/{id}',[LegalofficeAppointmentController::class,'meet'])->name('meet');
    Route::post('meeting-store/{id}',[LegalofficeAppointmentController::class,'meetingStore'])->name('meeting-store');
    Route::get('already-meet/{id}',[LegalofficeAppointmentController::class,'alreadyMeet'])->name('already-meet');
    Route::get('edit-prescription/{id}',[LegalofficeAppointmentController::class,'editPresciption'])->name('edit-prescription');
    Route::post('prescription-update/{id}',[LegalofficeAppointmentController::class,'updatePresciption'])->name('prescription-update');
    Route::get('prescription-doc-delete/{id}',[LegalofficeAppointmentController::class,'deleteDoc'])->name('prescription-doc-delete');
    Route::get('download-doc/{file}',[LegalofficeAppointmentController::class,'downloadFile'])->name('download-doc');


    // doctor payment
    Route::get('payment-history',[LegalofficeAppointmentController::class,'paymentHistory'])->name('payment.history');
    Route::get('search-payment-history',[LegalofficeAppointmentController::class,'searchPaymentHistory'])->name('search.payment.history');
    // doctor schedule
    Route::get('schedule',[LegalofficeScheduleController::class,'index'])->name('schedule');



    // search-doctor-appointment using ajax
    Route::get('search-appointment',[LegalofficeAppointmentController::class,'searchAppointment'])->name('search.appointment');
    Route::get('search-particular-appointment',[LegalofficeAppointmentController::class,'searchParticulerAppointment'])->name('search.particuler.appointment');


    Route::get('message',[LegalofficeMessageController::class,'index'])->name('message.index');
    Route::get('message-box/{id}',[LegalofficeMessageController::class,'messagebox'])->name('message.box');
    Route::get('get-message/{id}',[LegalofficeMessageController::class,'getmessage'])->name('get.message');
    Route::get('send-message',[LegalofficeMessageController::class,'sendmessage'])->name('send.message');



    Route::get('/zoom-meetings', [LegalofficeMeetingController::class,'index'])->name('zoom-meetings');
    Route::get('/create-zoom-meeting', [LegalofficeMeetingController::class,'createForm'])->name('create-zoom-meeting');
    Route::post('/store-zoom-meeting', [LegalofficeMeetingController::class,'store'])->name('store-zoom-meeting');
    Route::get('/edit-zoom-meeting/{id}', [LegalofficeMeetingController::class,'editForm'])->name('edit-zoom-meeting');
    Route::post('/update-zoom-meeting/{id}', [LegalofficeMeetingController::class,'updateMeeting'])->name('update-zoom-meeting');
    Route::get('/delete-zoom-meeting/{id}', [LegalofficeMeetingController::class,'destroy'])->name('delete-zoom-meeting');


    Route::get('/zoom', [LegalofficeMeetingController::class,'store'])->name('zoom');

    Route::get('/zoom-credential', [LegalZoomCredentialController::class,'index'])->name('zoom-credential');
    Route::post('/store-zoom-credential', [LegalZoomCredentialController::class,'store'])->name('store-zoom-credential');
    Route::post('/update-zoom-credential/{id}',[LegalZoomCredentialController::class,'update'])->name('update-zoom-credential');


    Route::get('/meeting-history', [LegalofficeMeetingController::class,'meetingHistory'])->name('meeting-history');
    Route::get('/upcomming-meeting', [LegalofficeMeetingController::class,'upCommingMeeting'])->name('upcomming-meeting');
